...
class AdminFoodController extends Controller
{
    public function index(Request $request)
    {
        ...
        $adminPage = $request->input('admin_page', 1);
        ...
        $news = News::paginate(8, ['*'], 'news_page', $newsPage);
        $users = User::paginate(8, ['*'], 'user_page', $userPage);
        $admins = Admin::paginate(8, ['*'], 'admin_page', $adminPage);

        return view('admin', compact('set_meals', 'dishes', 'side_menus', 'news', 'users', 'admins', 'tab'));
    }
